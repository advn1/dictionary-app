<template>
    <h3 class="text-gray-500 dark:text-gray-400">Source</h3>
    <a class="block break-words text-gray-600 dark:text-gray-200 underline" :href="srcLink">{{ srcLink }}</a>
...
const {word, srcLink} = defineProps(["word", "srcLink"])
</script>
